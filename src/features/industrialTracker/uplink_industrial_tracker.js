export default function decode(port, bytes){
...
if (port === 10) {
    decoder = [
        ...
        },
        {
            ...
            fn: function (arg) {
                // Acceleration
                var acceleration = {xaxis: null, yaxis: null, zaxis: null};
...
if (port === 100) {
    decoder = [
        ...
        },
        {
            ...
            fn: function (arg) {
                // loramac_opts
                var loramac_opts = {confirm_mode: null, sync_word: null, duty_cycle: null, adr: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // loramac_dr_tx
                var loramac_dr_tx = {dr_number: null, tx_power_number: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // loramac_rx2
                var loramac_rx2 = {frequency: null, dr_number: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // Event type 1
                var event_type1 = {m_value: null, n_value: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // Accelerometer
                var accelerometer = {xaxis_enabled: null, yaxis_enabled: null, zaxis_enabled: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // Sensitivity
                var sensitivity = {accelerometer_sample_rate: null, accelerometer_measurement_range: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                // Accelerometer tx
                var accelerometer_tx = {report_periodic_enabled: null, report_alarm_enabled: null};
        ...
        },
        {
            ...
            fn: function (arg) {
                ...
                var temperature_threshold = {high: null, low: null};
